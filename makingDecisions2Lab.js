...
switch (letterGrade) {
  case 'A':
    day = console.log("The student is doing excellently.");
    break;
  case 'B':
    day = console.log("The student is doing well.");
    break;
  case 'C':
     day = console.log("The student is doing alright.");
    break;
  case 'D':
    day = console.log("The student is not doing very well.");
    break;
  case 'F':
    day = console.log("The student is failing.");
    break;
}
